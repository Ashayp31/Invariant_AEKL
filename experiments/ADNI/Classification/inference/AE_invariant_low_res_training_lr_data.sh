...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/resolution_invariant_AE/test_classifier.py \
    ...
    --model_name=AE_invariant_classification_low_res \
    ...
    --model_checkpoint=/nfs/home/apatel/CT_PET_FDG/Resolution_Invariance/ADNI/AE_invariant_classification_low_res/checkpoint_20.pth \
    --batch_size=1 \
    --latent_channels=8 \
