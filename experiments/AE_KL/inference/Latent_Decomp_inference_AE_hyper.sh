...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/resolution_invariant_AE/run_ae_kl_invariant.py \
    --training_ids=/nfs/home/apatel/Data/PET_Challenge/processed/CT_1.6_1.6_2.5_clipped_registered \
		...
		--model_checkpoint=/nfs/home/apatel/CT_PET_FDG/Resolution_Invariance/CT/AE_KL_latent_decomp_hyperpartial_hlr/checkpoint_1400.pth \
    --model_name=AE_KL_latent_decomp_hyperpartial_hlr \
    --is_grayscale=1 \
