...
class ResampleBlock(nn.Module):
    ...
    def __init__(self, in_channels: int, intermediate_channels: int, slope: float=0.2, num_res_blocks=2) -> None:
        super().__init__()
        ...
        for i in range(num_res_blocks):
            resblocks.append(ResampleResBlock(intermediate_channels, slope))
        ...
        self.module4 = nn.Conv2d(intermediate_channels, in_channels, kernel_size=7,
                                 padding=3)
...
class ResBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv3d(n_channels=self.in_channels,
        ...
        self.conv2 = nn.Conv3d(n_channels=self.out_channels,
            out_channels=self.out_channels,
            strides=1,
            kernel_size=3,
            padding=1)
    ...
    def __init__(
        ...
        for i in range(len(num_channels)):
            ...
            if not is_final_block:
                blocks.append(ResampleBlock(in_channels=input_channel, intermediate_channels=input_channel))
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        for i in range(len(reversed_block_out_channels)):
            ...
            if not is_final_block:
                blocks.append(
                    ResampleBlock(in_channels=block_in_ch, intermediate_channels=block_in_ch)
                )
